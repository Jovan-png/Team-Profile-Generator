...
finishPrompt()
        ...
        console.log(employArr[0].Intern)
...
// Function for card creation
              const card = () =>{
                  ...
                  if(cRole === `Engineer`){
                      roleSpecific = `Github: <a href="https://github.com/${employArr[i].specific}">${employArr[i].specific}</a>`;
                  }else if (cRole === "Intern"){
                    roleSpecific = `School: ${employArr[i].specific}`
                  }else if (cRole === "Manager")
                  console.log(employArr[i].role)
                  roleSpecific = ` Office Number: ${employArr[i].specific}`
  return  `
